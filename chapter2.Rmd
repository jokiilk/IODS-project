...
```
Data set has 166 observations and 8 variables. 4 variables are integers, 3 numericals and 1 variable is a factor with 2 levels.
...
```{r}
kuvaaja <- ggpairs(learning2014, lower = list(combo = wrap("facethist", bins = 20)))
kuvaaja
```